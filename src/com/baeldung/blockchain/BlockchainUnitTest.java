...
//storing the blockchain in an array
...
//we've defined a prefix of four, which effectively means that we want our hash to start with four zeroes.



  //Setup of the new block
    @BeforeClass
